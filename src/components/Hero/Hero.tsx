    ...
    <>
      <div className="mt-28 md:mt-36 p-3 ">
        <div className="flex flex-col items-center justify-center space-y-3">
          ...
          {/* Add a z-index to this container to lift it above other elements */}
          <div className="relative z-10 w-full space-y-3 md:w-1/2 md:space-x-4 flex flex-col md:space-y-0 md:flex-row items-center justify-center m-auto text-center">
            {" "}
